...
def book():
    ...
    cancel_button = Button(window, text="Cancel", font=("Times New Roman", 20, 'bold'), fg='red', bg='#f5c542', command=cancel)
    cancel_button.grid(row=7, column=0, columnspan=2, padx=20, pady=20)
